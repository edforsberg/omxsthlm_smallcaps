...
for i = 1:length(tickers)
    ...
    % Otherwise, ignore this ticker symbol
        if status
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %
%Sección modificada de la función original
        ...
        %Busca índice cuando el volumen es 0 y elimina el índice de cada lista
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         
%Esta sección comentada es la que se sustituyó por la sección anterior        
